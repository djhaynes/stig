...
#
# If IPv6 is disabled at the kernel level these will cause the chef script to fail
# So, allow for bypassing of the vivification of the variables
# Otherwise you will have a failure in ./cookbooks/sysctl/recipes/default.rb
#
if node['stig']['network']['ipv6_active_in_kernel'] != 'no'
...
default['stig']['sshd_config']['rhosts_rsa_authentication'] = 'yes'
